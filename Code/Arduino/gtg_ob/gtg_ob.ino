...
void avoidObstacle(){
  // transform the ultrasonic sensor distance to a point in the robot coordinate frame
//      float* obDistances_wf = applySensorGeometry(obDistances);
//      float sensorGain[5] = [1,1,1,1,1];
...
float* getTransformationMatrix(x,,y,theta){
//output 3 by 3 transformation matrix  
}
float* applySensorGeometry(float* obDistances){
// output 5 by 1 vector which obstacle coordinate in the world frame 
}
